...
const recipeDbController_1 = require("../controllers/recipeDbController");
const recipeCostEstimationController_1 = require("../controllers/recipeCostEstimationController");
 ...
 */
router.post("/ingredients-from-ai-with-costs", recipeCostEstimationController_1.getRecipeFromAi);
/**
 * @openapi
 * /cost-of-ingredients:
 *   post:
 ...
 *         description: Internal Server Error occurred.
 */
router.post("/cost-of-ingredients", recipeCostEstimationController_1.getRecipeCostEstimation);
/**
 * @openapi
 * /recipe:
 *   post:
 ...
 *         description: Internal Server Error occurred.
 */
router.post("/recipe", recipeDbController_1.insertRecipe);
/**
 * @openapi
 * /recipe:
 *   get:
 ...
 *         description: Internal Server Error occurred.
 */
router.get("/recipe", recipeDbController_1.getRecipe);
/**
 * @openapi
 * /recipe:
 *   put:
 ...
 *         description: Internal Server Error occurred.
 */
router.put("/recipe", recipeDbController_1.updateRecipe);
/**
 * @openapi
 * /recipe:
 *   delete:
 ...
 *         description: Internal Server Error occurred.
 */
router.delete("/recipe", recipeDbController_1.deleteRecipe);
/**
 * @openapi
 * /search-for-recipe:
 *   get:
 ...
 *         description: Internal Server Error occurred.
 */
router.get("/search-for-recipe", recipeDbController_1.searchForRecipes);

...
exports.getActualQuantity = getActualQuantity;
exports.extractListsFromAIResponse = extractListsFromAIResponse;
exports.calculateCostOfIngredients = calculateCostOfIngredients;
exports.equalsIgnoreCase = equalsIgnoreCase;
exports.hasIngredientSubstringWithUnit = hasIngredientSubstringWithUnit;
...
function hasIngredientSubstringWithUnit(map, ingredientName, unit) {
    for (const [key, value] of map.entries()) {
        if (key.toLowerCase().includes(ingredientName.toLowerCase()) &&
            value === unit) {
